...
#  npx circom -v -r artifacts/circuits/transaction2.r1cs -w artifacts/circuits/transaction2.wasm -s artifacts/circuits/transaction2.sym circuits/transaction2.circom